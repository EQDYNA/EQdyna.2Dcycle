...
par.fric_fd = 0.465
par.fric_fv = 0.49
par.fric_fini = 0.45    # match paper.saf.A inverted value (gives ~540 yr first interval)
par.critd0 = 0.5 # m
par.critv0 = 0.2 # m/s 
par.critt0 = 0.2 # s
...
par.eta0 = 8.4e21 # Pa-s, pseudo viscosity for interseismic loading solution.
...
par.dxy = 400. # m, cell size (lite resolution; paper.saf.A uses 200m)
