...
- Reference cases: `compset/saf.gmsh.lite/` (paper-faithful), `compset/subei.gmsh.lite/`, `compset/gulang.gmsh.lite/`, plus the legacy `compset/test.saf/`, `compset/test.subei/`, `compset/test.gulang/`
